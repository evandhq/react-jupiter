...
var _icomoon = _interopRequireDefault(require("../../docs/assets/fonts/icomoon.woff"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}


const FontStyle = (0, _styledComponents.createGlobalStyle)`
  @font-face {
    font-family: 'Jupiterico';
    src: url(${_icomoon.default}) format('woff'); /* Updated path based on staticDirs */
    font-weight: normal;
    font-style: normal;
