...
{let { groupName = 'radio-element', label = '', handleChange = () => {}, defaultCheckedValue = '', isDisabled = false, type = 'horizontal', errorMessage = '', children } = _ref;
  ...
  return (/*#__PURE__*/
    ...
    radioElements.map(
      (radioElement) =>
      isDisabled ?
      _react.default.cloneElement(radioElement, { groupName, defaultCheckedValue, isDisabled }) :

      _react.default.cloneElement(radioElement, { groupName, defaultCheckedValue })
