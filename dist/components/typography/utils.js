"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getSizeOfHeading = exports.getMarginOfHeading = void 0;const getSizeOfHeading = (theme, size, level) => {
  switch (size) {
...
const getMarginOfHeading = (theme, size, level) => {
  switch (size) {
    case theme.sizes.small:
